 ...
 * 
 */
@WebServiceClient(name = "WebServiceService", targetNamespace = "http://arestanov.com/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVICE_QNAME = new QName("http://arestanov.com/", "WebServiceService");
    ...
    public WebServiceInterface_1 getWebServicePort() {
        return super.getPort(new QName("http://arestanov.com/", "WebServicePort"), WebServiceInterface_1.class);
    }
     ...
     */
    @WebEndpoint(name = "WebServicePort")
    public WebServiceInterface_1 getWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://arestanov.com/", "WebServicePort"), WebServiceInterface_1.class, features);
    }
